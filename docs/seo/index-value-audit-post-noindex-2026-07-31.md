...
This audit evaluates 1669 built content pages. It uses rendered word count,
...
It excludes 25 reviewed pages that already emit a robots noindex directive.
...
| Noindex review | 302 | Thin or highly repeated page requiring manual review |

High-confidence noindex-review candidates: 96.
...
- 96 pages have a body below 450 words or normalized paragraph reuse of at least 80%.
...
Full row-level evidence is in `index-value-audit-post-noindex-2026-07-31.csv`.
